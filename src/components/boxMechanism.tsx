...
export const BoxMechanism: React.FC<BoxMechanismProps> = (props) => {
    ...
    return (
        <div style={{display: 'flex',  marginTop: '30px'}} >
            <BlockItem setOutputBox={setOutputBox} setInputBox={setInputBox} setBoxes={setBoxes} outputBox={outputBox}
                       boxes={boxes} setBoxCounter={setBoxCounter} boxCounter={boxCounter} birth={birth} percent={percent} />
